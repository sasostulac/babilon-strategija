  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-WF2JTKRN.js"),
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-NAFBQ2WJ.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-4XLPPYYO.js"), import("./depth.fragment-CCK5JDXU.js")]);
    } else {
      await Promise.all([import("./depth.vertex-2F7OMWUD.js"), import("./depth.fragment-FB4LWFMM.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
//# sourceMappingURL=chunk-VEFBIZWV.js.map
