    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-RG574A42.js"), import("./openpbr.fragment-JP4GX7ZK.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-CX37WECW.js"), import("./openpbr.fragment-RTUW3XSU.js")]);
        }
...
//# sourceMappingURL=chunk-YJPQAKMU.js.map
