    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-WDCJA6JO.js"), import("./pbr.fragment-D6CCY6QJ.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-4MDDSIWL.js"), import("./pbr.fragment-MWJDAAUT.js")]);
        }
...
//# sourceMappingURL=chunk-BZY5AEX3.js.map
