      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-2YA3WXMC.js"), import("./default.fragment-PAOI73DW.js")]);
          } else {
            await Promise.all([import("./default.vertex-VKAPYAJK.js"), import("./default.fragment-OSJXRBPY.js")]);
          }
...
//# sourceMappingURL=chunk-JPDS7OIY.js.map
