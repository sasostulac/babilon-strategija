...
uniform sampler2D tex3;   // cliff texture
uniform sampler2D tex4;   // fog of war (black)

uniform vec3 lightDirection;
uniform vec3 lightColor;
uniform vec3 ambientColor;

// --- Cliff parameters (set from JS) ---
